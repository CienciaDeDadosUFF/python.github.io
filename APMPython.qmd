---
title:  "Aprendizado de Máquinas com Python"
format:
  html:
    code-fold: false
toc: true
...
Neste capítulo, vamos estudar sobre os algoritmos de predição, que são capazes de inferir se um dado pertence ou não a uma certa categoria. Dessa forma, eles são construidos utilizando as seguintes etapas:
