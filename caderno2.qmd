...
OBS: pip ("Pip Installs Packages") É O GERENCIADOT DE PACOTES! FERRMENTE QUE PERMITE INSTALAR, ATUALUZAR E REMOVES BIBLIOTECAS E MÓDULOS NO PYTHON DE FORMA FÁCIL. 
*O `pip` é um repositório que armazena diversos pacotes e módulos. Se o Python estiver adicionado ao PATH digite no terminal do windows:\\~\~\~ \$ pip --version \~\~\~*
