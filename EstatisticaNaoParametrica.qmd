...
**Passo 5:** O **p-valor** pode ser calculado através do Python. E para um determinado nível de significância $\alpha$ tomar a decisão de rejeitar ou não a hipótese nula.
...
**Passo 8:** Calcule o p-valor associado a $W$. E para um determinado nível de significância tomar a decisão de rejeitar ou não a hipótese nula.
...
**Passo 5:** Calcule o p-valor associado a $H$. E para um determinado nível de significância tomar a decisão de rejeitar ou não a hipótese nula.
...
**Passo 5:** Calcule o p-valor associado a $Q$. E para um determinado nível de significância tomar a decisão de rejeitar ou não a hipótese nula.
...
print(f"Estatística Q = {stat:.4f}, p-valor= {p_valor:.4f}")
...
**Passo 6:** Calcule o p-valor associado. E para um determinado nível de significância tomar a decisão de rejeitar ou não a hipótese nula.
