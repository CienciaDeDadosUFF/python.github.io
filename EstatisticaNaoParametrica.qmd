...
Combine as duas amostras em ordem crescente:
...
#### **Passo 3:** Calcule a soma dos postos para cada amostra. 

Denote por $R_X$ e $R_Y$ as somas dos postos atribuídos aos elementos das amostras $X$ e $Y$, respectivamente. 
...
Sejam $n_X$ e $n_Y$ os tamanhos das amostras $X$ e $Y$, respectivamente. Defina  
$$U = \min(U_X, U_Y),$$
...
#### **Passo 5:** Calcular p-valor.  

O **p-valor** pode ser calculado através do Python. E para um determinado nível de significância $\alpha$ tomar a decisão de rejeirar ou não a hipótese nula.
