...
Sempre que colocamos números com a parte decimal explicita, o Python reconhece como um `float`. Lembrando que a linguagem usa o sistema americano, que utiliza o ponto como separador decimal.
...
Note que o Python por padrão corta os zeros à direita, ele só mantém o primeiro decimal obrigatório para mostrar que se trata de um `float`.
